...
#open psi46handler in annother terminal
    psiChild = subprocess.Popen("xterm +sb -geometry 120x20+0+900 -fs 10 -fa 'Mono' -e 'python ../python/psi46handler.py -dir %s'"%(Directories['logDir']), shell=True,preexec_fn = preexec)
