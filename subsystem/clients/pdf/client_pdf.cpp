/**
 * client_irc.cpp
 * bi-directional subscriber client and irc bridge
...
int main(int argc, char *argv[]) {
	...
	pdf_client* mypdf = new pdf_client("./test.pdf");
	mypdf->init();
