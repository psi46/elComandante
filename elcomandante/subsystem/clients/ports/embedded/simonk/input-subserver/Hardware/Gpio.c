...
{
	{	&PINC, &PORTC, &DDRC, PC0},	// 0
	{	&PINC, &PORTC, &DDRC, PC1},	// 1
	{	&PINC, &PORTC, &DDRC, PC2},	// 2
	{	&PINC, &PORTC, &DDRC, PC3},	// 3
	{	&PINC, &PORTC, &DDRC, PC4},	// 4
	{	&PINC, &PORTC, &DDRC, PC5},	// 5
	{	&PIND, &PORTD, &DDRD, PD0},	// 6
	{	&PIND, &PORTD, &DDRD, PD1},	// 7
	{	&PIND, &PORTD, &DDRD, PD2},	// 8
	{	&PIND, &PORTD, &DDRD, PD3},	// 9
	{	&PIND, &PORTD, &DDRD, PD4},	// 10
	{	&PIND, &PORTD, &DDRD, PD5},	// 11
	{	&PIND, &PORTD, &DDRD, PD6},	// 12
	{	&PIND, &PORTD, &DDRD, PD7}	// 13
};
